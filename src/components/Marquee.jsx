...
const Marquee = ({
  ...
  //   CONSTANTS
  const StarIcon = "mdi:star-four-points";
  ...
  //   gsap-marquee animation-pre-built
  function horizontalLoop(items, config) {
    items = gsap.utils.toArray(itemsRef.current);
    config = config || {};
    ...
    >
      ...
      <div className="flex">
        {items.map((item, idx) => (
          ...
          >
            {item}
            <Icon icon={icon ? icon : StarIcon} className={iconClassName} />
          </span>
        ))}
      </div>
    </div>
